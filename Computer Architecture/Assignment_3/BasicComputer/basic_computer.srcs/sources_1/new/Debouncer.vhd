...
--                of the datain and dataout std_logic_vectors
--   DEBNC_CLOCKS - The number of clocks (clk) to wait before registering
--                  a change.
--
-- Port Descriptions:
--
--   datain - The input signals. A vector of width equal to PORT_WIDTH
--   clk  - Input clock
--   dataout - The debounced signals. A vector of width equal to PORT_WIDTH
--   											
----------------------------------------------------------------------------
--
----------------------------------------------------------------------------
