...
<body>
    ...
    <section class="mt-4">
      <div class="container" id="resultados_reservas">
        <div class="row">
          <div class="col">
            <?php
              $user_id = $_SESSION["id"];
              ...
              $query = "SELECT Hab.nombre,Hab.habid,Res.fecha_inicio,Res.fecha_fin, (Res.fecha_fin - Res.fecha_inicio)*Hab.precio FROM reservas as Res, habitaciones as Hab WHERE Res.habid=Hab.habid AND Res.uid='$user_id' ORDER BY Res.habid DESC;";
