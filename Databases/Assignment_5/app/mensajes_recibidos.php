<?php
  ...
  session_start();
  $user_id = $_SESSION["id"];
  $datos = json_decode(CallAPI("GET", "https://young-waters-69541.herokuapp.com/user_recibidos/$user_id"), true);
?>
<h2 align="center">Tus Mensajes recibidos</h2>
<?php foreach ($datos['mensajes'] as $d): ?>
<p>Mensaje de:
<?php 
    $idu = print_r($d['sender'], true);
